...
import kotlinx.android.synthetic.main.fragment_fav_next_match.*
...
class FavoriteNextMatchFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_fav_next_match, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_favNextMatch.layoutManager = LinearLayoutManager(context)
        rv_favNextMatch.adapter = adapter
